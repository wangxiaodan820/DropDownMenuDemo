...
- (TitleDropMenuView *)titleView {
    if(!_titleView) {
        _titleView = [TitleDropMenuView TitleDropMenuViewInitWithFrame:CGRectMake(0, NAV_SaferHeight, self.view.frame.size.width, 44) otherSetting:^(TitleDropMenuView *titleMenuView) {
